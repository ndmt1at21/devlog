...
const vi: Dict = {
  ...
  editor: {
    ...
    coverAltLabel: "Mô tả ảnh bìa (alt)",
    coverAltPlaceholder: "Mô tả ngắn cho ảnh bìa (alt)",
...
const en: Dict = {
  ...
  editor: {
    ...
    coverAltLabel: "Cover image description (alt)",
    coverAltPlaceholder: "Short cover image description (alt)",
